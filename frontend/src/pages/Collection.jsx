  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        <p onClick={() => setShowFilter(!showFilters)} className='my-2 text-xl flex items-center cursor-pointer gap-2'>FILTERS</p>
      ...
      <div className='flex-1'>
        ...
        <div className='flex justify-between text-base sm:test-2x1 mb-4'>
